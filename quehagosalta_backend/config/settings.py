"""
Django settings for quehagosalta_back project.
...
SECRET_KEY = 'django-insecure-l#7i29l(%ixc_1q^)@61+z=(@n%7^jz3jm^by11k_%$)ds%ey$'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['*']
GLOBAL_IP = '10.120.160.98'  # Tu IP local actual de la red de tu casa
GLOBAL_HOST = '8000'
